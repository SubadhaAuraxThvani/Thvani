...
const options: Option[] = [
  { id: "story", label: "story", title: "OUR AESTHETIC", img: storyImg, text: "Thvani embodies a slow way of life that is rooted in culture, craft and community. Each Buna garment is a play of natural fabrics defining a life of breath-ability, light and airiness that it wants its wearers to be part of." },
  { id: "craft", label: "craft", title: "ARTISANAL", img: craftImg, text: "Our fabrics are custom made in small batches by artisanal communities of India who weave the story of Buna. Each garment is carefully and slowly handcrafted in our studio in Delhi with thoughtful details before it completes its journey in your wardrobe, ready to be a part of your story." },
