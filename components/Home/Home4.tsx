        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            <div className="relative">
                ...
                <div className="absolute bottom-5 left-5 text-right gap-3">
                    <p className="text-white font-bold mb-4 text-lg sm:text-xl">NEW STOCK</p>
                    <Link href="/women">
            ...
            <div className="relative">
                ...
                <div className="absolute bottom-5 left-5 text-right gap-3">
                    <p className="text-white font-bold mb-4 text-lg sm:text-xl">BACK IN STOCK</p>
                    <Link href="/women">
                        <button className="min-w-0 bg-white rounded text-black text-sm px-3 py-[10px] font-medium flex items-center gap-2">
                            SHOP <FaArrowRight />
                        </button>
            ...
            <div className="relative">
                ...
                <div className="absolute bottom-5 left-5 text-right gap-3">
                    <p className="text-white font-bold mb-4 text-lg sm:text-xl">BEST SELLERS</p>
                    <Link href="/women">
                        <button className="min-w-0 bg-white rounded text-black text-sm px-3 py-[10px] font-medium flex items-center gap-2">
                            SHOP <FaArrowRight />
                        </button>
