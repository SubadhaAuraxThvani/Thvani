...
export default function Home7() {
    return (
        <div className="flex lg:h-[50vh] my-[50px] flex-col lg:flex-row lg:text-left text-center">
            <div className="flex w-full justify-center border-4 border-dotted p-4 lg:p-[2vw] border-color4 lg:w-2/3 lg:mx-[100px] flex-col gap-5">
            ...
            <div className="flex w-full mb-8 lg:w-1/3 justify-center lg:mx-[100px] flex-col gap-5">
                <span className="text-2xl lg:text-[2.2vw] leading-tight">Our Uniqueness: Fashion Rooted in Natures Wisdom</span>
