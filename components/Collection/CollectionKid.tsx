...
export default function CollectionPageKids() {
    return (
        <div className="flex flex-col py-8 md:py-[50px]">
            <div className="flex flex-col gap-4 w-full">
                <div className="px-4 md:px-[50px]">
                    <p>Home / Kids</p>
                    <p className="text-2xl md:text-3xl font-bold">Kids Clothing</p>
                    <p className="text-base md:text-lg">
                        Discover fun and comfortable clothing for kids, designed with care and quality.
                    </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-4 md:px-[50px]">
                    ...
                    <div className="flex flex-col gap-2 p-2 rounded-lg">
                        ...
                        />
                        <p className="font-bold text-lg lg:text-left text-center">Kids Sale</p>
                    ...
                    <div className="flex flex-col gap-2 p-2 rounded-lg">
                        <Image
                            alt="Kids New Arrival"
                            src={img2}
                            className="rounded-lg w-full h-[40vh] sm:h-[35vh] lg:h-[45vh] object-cover"
                        />
                        <p className="font-bold text-lg lg:text-left text-center">Kids New Arrival</p>
                        <div className="flex justify-center lg:justify-start">
                            <button className="p-2 px-6 bg-black text-white rounded-md text-sm hover:bg-gray-800 transition-colors duration-200">
                                Shop
                            </button>
                    ...
                    <div className="flex flex-col gap-2 p-2 rounded-lg">
                        <Image
                            ...
                            className="rounded-lg w-full h-[40vh] sm:h-[35vh] lg:h-[45vh] object-cover"
                        />
                        <p className="font-bold text-lg lg:text-left text-center">Kids Dress</p>
                        <div className="flex justify-center lg:justify-start">
                            <button className="p-2 px-6 bg-black text-white rounded-md text-sm hover:bg-gray-800 transition-colors duration-200">
                                Shop
                            </button>
                    ...
                    <div className="flex flex-col gap-2 p-2 rounded-lg">
                        <Image
                            ...
                            className="rounded-lg w-full h-[40vh] sm:h-[35vh] lg:h-[45vh] object-cover"
                        />
                        <p className="font-bold text-lg lg:text-left text-center">Kids Ethnic Wear</p>
                        <div className="flex justify-center lg:justify-start">
                            <button className="p-2 px-6 bg-black text-white rounded-md text-sm hover:bg-gray-800 transition-colors duration-200">
                                Shop
                            </button>
                ...
                <div className="flex flex-col md:flex-row py-8 px-4 md:px-[50px] gap-8">
                    ...
                    <div className="flex flex-col w-full gap-10">
                        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-5 lg:px-20 justify-items-center">
                            <CollectionProduct img={img1} text="Kids Organic Fleece Sweatshirt" />
                            <CollectionProduct img={img2} text="Kids Organic Pocket Hoodie" />
                            <CollectionProduct img={img3} text="Kids Cotton Classic Tee" />
                            <CollectionProduct img={img1} text="Kids Organic Fleece Sweatshirt" />
                            <CollectionProduct img={img2} text="Kids Organic Pocket Hoodie" />
                            <CollectionProduct img={img3} text="Kids Cotton Classic Tee" />
                            <CollectionProduct img={img1} text="Kids Organic Fleece Sweatshirt" />
