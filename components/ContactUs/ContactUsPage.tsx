    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row">
                ...
                <div className="flex flex-col w-full lg:w-1/2 px-6 sm:px-8 lg:px-[100px] py-6 sm:py-8 lg:py-[50px] gap-6 sm:gap-8">
            ...
            <div className="flex flex-col items-center py-[50px] sm:py-[80px] px-6 sm:px-8 lg:px-[100px]">
                ...
                <div className="flex flex-col py-[30px] sm:py-[50px] gap-5 w-full lg:w-[50%] justify-center">
                    ...
                    {/* Submit Button */}
                    <div className="flex flex-col rounded-lg bg-color1 w-full sm:w-[20vw] text-center justify-center items-center">
