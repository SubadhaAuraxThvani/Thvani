    ...
    return (
        <div className="flex flex-col lg:flex-row w-full py-10 px-5 sm:px-10 md:px-20 lg:px-[100px] gap-5">
            <div className="flex flex-col gap-5 p-5 sm:p-10 w-full lg:w-1/2">
                ...
                <div className="flex items-center border-2 w-full p-2 gap-3 sm:gap-5 rounded-lg">
                    <input placeholder="First Name" className="w-full outline-none" />
                </div>
                <div className="flex items-center border-2 w-full p-2 gap-3 sm:gap-5 rounded-lg">
                    <input placeholder="Last Name" className="w-full outline-none" />
                </div>
                <div className="flex items-center border-2 w-full p-2 gap-3 sm:gap-5 rounded-lg">
                ...
                <div className="flex sm:flex-row flex-col justify-between w-full gap-3 sm:gap-5">
                    <div className="bg-color1 h-12 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg">
